...
if uploaded_file:
    ...
    if job_description:
        ...
        # -----------------------------------------------
        # Donut Chart + AI Verdict Card
        # -----------------------------------------------

        # chart_col, verdict_col = st.columns([1.3, 1])
        # chart_col, verdict_col = st.columns([0.9, 1.1])
        chart_col, verdict_col = st.columns([1, 1])
        ...
        with verdict_col:
            ...
            if score >= 80:
                ...
                verdict = "⚠ Consider"
                recommendation = "Review Missing Skills"

            else:
                verdict = "❌ Weak Match"
                recommendation = "Additional Screening Needed"
